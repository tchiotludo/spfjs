...
var $spf$config$defaults$$ = {"animation-class":"spf-animate", "animation-duration":425, "cache-lifetime":6E5, "cache-max":50, "cache-unified":!1, "link-class":"spf-link", "nolink-class":"spf-nolink", "navigate-limit":20, "navigate-lifetime":864E5, "reload-identifier":null, "request-timeout":0, "url-identifier":"?spf=__type__", "use-iframe":!0}, $spf$config$values$$ = {};
...
;function $spf$history$add$$($opt_url$$3$$, $opt_state$$, $opt_doCallback$$) {
  $spf$debug$info$$("history.add ", $opt_url$$3$$);
  $spf$history$push_$$(!1, $opt_url$$3$$, $opt_state$$, $opt_doCallback$$);
}
...
function $spf$history$push_$$($pushState$$inline_19_replace$$, $opt_url$$5_url$$12$$, $opt_state$$2_state$$2$$, $callback$$32_opt_doCallback$$2$$) {
  if ($opt_url$$5_url$$12$$ || $opt_state$$2_state$$2$$) {
    ...
    if ($pushState$$inline_19_replace$$) {
      ...
      $pushState$$inline_19_replace$$ = $spf$history$getIframe$$().history.pushState;
      if ("function" == typeof $pushState$$inline_19_replace$$) {
        $pushState$$inline_19_replace$$.call(window.history, $opt_state$$2_state$$2$$, "", $opt_url$$5_url$$12$$);
      } else {
...
function $spf$history$doReplaceState_$$($data$$27$$, $opt_url$$7$$) {
  var $replaceState$$ = $spf$history$getIframe$$().history.replaceState;
...
function $spf$history$getIframe$$() {
  var $frame$$ = null;
  $spf$config$values$$["use-iframe"] ? (($frame$$ = document.getElementById("history-iframe")) || ($frame$$ = $spf$dom$createIframe$$("history-iframe")), $frame$$ = $frame$$.contentWindow) : $frame$$ = window;
  return $frame$$;
}
...
function $spf$cache$collect$$() {
  var $storage$$3_storage$$inline_21$$ = $spf$cache$storage_$$(), $extra$$inline_23_key$$23_max$$inline_22$$;
  for ($extra$$inline_23_key$$23_max$$inline_22$$ in $storage$$3_storage$$inline_21$$) {
    $spf$cache$valid_$$($storage$$3_storage$$inline_21$$[$extra$$inline_23_key$$23_max$$inline_22$$]) || delete $storage$$3_storage$$inline_21$$[$extra$$inline_23_key$$23_max$$inline_22$$];
  }
  $storage$$3_storage$$inline_21$$ = $spf$cache$storage_$$();
  $extra$$inline_23_key$$23_max$$inline_22$$ = parseInt($spf$config$values$$["cache-max"], 10);
  $extra$$inline_23_key$$23_max$$inline_22$$ = isNaN($extra$$inline_23_key$$23_max$$inline_22$$) ? Infinity : $extra$$inline_23_key$$23_max$$inline_22$$;
  $extra$$inline_23_key$$23_max$$inline_22$$ = Object.keys($storage$$3_storage$$inline_21$$).length - $extra$$inline_23_key$$23_max$$inline_22$$;
  if (!(0 >= $extra$$inline_23_key$$23_max$$inline_22$$)) {
    for (var $i$$inline_24$$ = 0;$i$$inline_24$$ < $extra$$inline_23_key$$23_max$$inline_22$$;$i$$inline_24$$++) {
...
;function $spf$net$resource$load$$($el_type$$78$$, $url$$23$$, $name$$52$$, $check_opt_fn$$) {
  ...
  var $isJS_key$$inline_31_prevName$$ = $el_type$$78$$ == $spf$net$resource$Type$JS$$;
  ...
  $name$$52$$ && ($prevUrl$$ = $spf$net$resource$url$get$$($el_type$$78$$, $name$$52$$)) && $url$$23$$ != $prevUrl$$ && ($spf$dispatch$$($isJS_key$$inline_31_prevName$$ ? "spfjsbeforeunload" : "spfcssbeforeunload", {name:$name$$52$$, url:$prevUrl$$}), $spf$net$resource$unloadPrepare_$$($el_type$$78$$, $name$$52$$, $prevUrl$$), $spf$pubsub$subscribe$$($topic$$6$$, $spf$bind$$($spf$net$resource$unloadComplete_$$, null, $el_type$$78$$, $name$$52$$, $prevUrl$$)));
  $isJS_key$$inline_31_prevName$$ = $spf$net$resource$key$$($el_type$$78$$, $url$$23$$);
  if (($isJS_key$$inline_31_prevName$$ = $spf$net$resource$name_$$[$isJS_key$$inline_31_prevName$$]) && $pseudonym$$ != $isJS_key$$inline_31_prevName$$) {
    var $key$$inline_35_key$$inline_39_key$$inline_47_oldTopic$$inline_41$$ = $spf$net$resource$key$$($el_type$$78$$, $isJS_key$$inline_31_prevName$$);
    delete $spf$net$resource$url_$$[$key$$inline_35_key$$inline_39_key$$inline_47_oldTopic$$inline_41$$];
    $key$$inline_35_key$$inline_39_key$$inline_47_oldTopic$$inline_41$$ = $spf$net$resource$key$$($el_type$$78$$, $url$$23$$);
    delete $spf$net$resource$name_$$[$key$$inline_35_key$$inline_39_key$$inline_47_oldTopic$$inline_41$$];
    ($key$$inline_35_key$$inline_39_key$$inline_47_oldTopic$$inline_41$$ = $spf$net$resource$key$$($el_type$$78$$, $isJS_key$$inline_31_prevName$$)) && $topic$$6$$ && $key$$inline_35_key$$inline_39_key$$inline_47_oldTopic$$inline_41$$ in $spf$pubsub$subscriptions$$ && ($spf$pubsub$subscriptions$$[$topic$$6$$] = ($spf$pubsub$subscriptions$$[$topic$$6$$] || []).concat($spf$pubsub$subscriptions$$[$key$$inline_35_key$$inline_39_key$$inline_47_oldTopic$$inline_41$$]), delete $spf$pubsub$subscriptions$$[$key$$inline_35_key$$inline_39_key$$inline_47_oldTopic$$inline_41$$]);
  }
  $key$$inline_35_key$$inline_39_key$$inline_47_oldTopic$$inline_41$$ = $spf$net$resource$key$$($el_type$$78$$, $url$$23$$);
  $spf$net$resource$name_$$[$key$$inline_35_key$$inline_39_key$$inline_47_oldTopic$$inline_41$$] = $pseudonym$$;
  ...
  $spf$net$resource$status$get$$($el_type$$78$$, $url$$23$$) ? ($isJS_key$$inline_31_prevName$$ && $pseudonym$$ != $isJS_key$$inline_31_prevName$$ && ($el_type$$78$$ = $spf$net$resource$find$$($el_type$$78$$, $url$$23$$)) && $el_type$$78$$.setAttribute("name", $name$$52$$ || ""), $check_opt_fn$$()) : ($el_type$$78$$ = $spf$net$resource$create$$($el_type$$78$$, $url$$23$$, $check_opt_fn$$, void 0, void 0, $prevUrl$$)) && $name$$52$$ && $el_type$$78$$.setAttribute("name", $name$$52$$);
}
...
function $spf$net$resource$unloadPrepare_$$($topic$$7_type$$80$$, $name$$54$$, $key$$inline_55_url$$25$$) {
  $spf$debug$debug$$("  > resource.unloadPrepare_", $topic$$7_type$$80$$, $key$$inline_55_url$$25$$);
  var $key$$inline_51$$ = $spf$net$resource$key$$($topic$$7_type$$80$$, $name$$54$$);
  delete $spf$net$resource$url_$$[$key$$inline_51$$];
  $key$$inline_55_url$$25$$ && ($key$$inline_55_url$$25$$ = $spf$net$resource$key$$($topic$$7_type$$80$$, $key$$inline_55_url$$25$$), delete $spf$net$resource$name_$$[$key$$inline_55_url$$25$$]);
...
function $spf$net$resource$destroy$$($type$$84$$, $url$$28$$) {
  ...
  var $el$$2_key$$inline_61$$ = $spf$net$resource$find$$($type$$84$$, $url$$28$$, void 0);
  $el$$2_key$$inline_61$$ && $el$$2_key$$inline_61$$.parentNode && $el$$2_key$$inline_61$$.parentNode.removeChild($el$$2_key$$inline_61$$);
  $el$$2_key$$inline_61$$ = $spf$net$resource$key$$($type$$84$$, $url$$28$$);
  delete $spf$net$resource$status_$$[$el$$2_key$$inline_61$$];
}
...
function $spf$net$resource$discover$$($type$$86$$) {
  ...
  $spf$array$each$$($spf$dom$query$$($isJS$$3$$ ? "script[src]" : 'link[rel~="stylesheet"]'), function($el$$3$$) {
    ...
    if (!$spf$net$resource$status$get$$($type$$86$$, $url$$30$$)) {
      ...
      if ($name$$56$$) {
        var $key$$inline_66$$ = $spf$net$resource$key$$($type$$86$$, $url$$30$$);
        $spf$net$resource$name_$$[$key$$inline_66$$] = $name$$56$$;
...
function $spf$net$resource$eval$$($type$$89$$, $el$$7_text$$10$$, $name$$57$$) {
  for (var $previous$$ = $spf$net$resource$url$get$$($type$$89$$, $name$$57$$), $cls$$5_id$$7_label$$8_str$$inline_68$$ = $el$$7_text$$10$$.replace(/\s/g, ""), $cls$$5_id$$7_label$$8_str$$inline_68$$ = $cls$$5_id$$7_label$$8_str$$inline_68$$ || "", $result$$inline_69$$ = 0, $i$$inline_70$$ = 0, $l$$inline_71$$ = $cls$$5_id$$7_label$$8_str$$inline_68$$.length;$i$$inline_70$$ < $l$$inline_71$$;++$i$$inline_70$$) {
    $result$$inline_69$$ = 31 * $result$$inline_69$$ + $cls$$5_id$$7_label$$8_str$$inline_68$$.charCodeAt($i$$inline_70$$), $result$$inline_69$$ %= 4294967296;
  }
  $cls$$5_id$$7_label$$8_str$$inline_68$$ = "hash-" + $result$$inline_69$$;
  $spf$net$resource$url$set$$($type$$89$$, $name$$57$$, $cls$$5_id$$7_label$$8_str$$inline_68$$);
  !$spf$net$resource$status$loaded$$($type$$89$$, $cls$$5_id$$7_label$$8_str$$inline_68$$) && ($el$$7_text$$10$$ = $spf$net$resource$exec$$($type$$89$$, $el$$7_text$$10$$)) && ($spf$net$resource$status$set$$($spf$net$resource$State$LOADED$$, $type$$89$$, $cls$$5_id$$7_label$$8_str$$inline_68$$), $el$$7_text$$10$$ && ($cls$$5_id$$7_label$$8_str$$inline_68$$ = $spf$net$resource$label$$($cls$$5_id$$7_label$$8_str$$inline_68$$), $cls$$5_id$$7_label$$8_str$$inline_68$$ = $spf$net$resource$key$$($type$$89$$, 
  $cls$$5_id$$7_label$$8_str$$inline_68$$), $el$$7_text$$10$$.className = $cls$$5_id$$7_label$$8_str$$inline_68$$, $el$$7_text$$10$$.setAttribute("name", $name$$57$$)), ($previous$$ = $previous$$ && $previous$$[0]) && $spf$net$resource$destroy$$($type$$89$$, $previous$$));
}
...
function $spf$nav$response$process$$($url$$55$$, $response$$1$$, $opt_info$$, $opt_callback$$8$$) {
  ...
  $response$$1$$.attr && ($fn$$17_num$$5$$ = $spf$bind$$(function($attrs$$, $timing$$1$$) {
    for (var $id$$9$$ in $attrs$$) {
      var $el$$11_element$$inline_75$$ = document.getElementById($id$$9$$);
      if ($el$$11_element$$inline_75$$) {
        var $attributes$$inline_76$$ = $attrs$$[$id$$9$$], $name$$inline_77$$ = void 0;
        for ($name$$inline_77$$ in $attributes$$inline_76$$) {
          var $value$$inline_78$$ = $attributes$$inline_76$$[$name$$inline_77$$];
          "class" == $name$$inline_77$$ ? $el$$11_element$$inline_75$$.className = $value$$inline_78$$ : "style" == $name$$inline_77$$ ? $el$$11_element$$inline_75$$.style.cssText = $value$$inline_78$$ : ($el$$11_element$$inline_75$$.setAttribute($name$$inline_77$$, $value$$inline_78$$), "value" == $name$$inline_77$$ && ($el$$11_element$$inline_75$$[$name$$inline_77$$] = $value$$inline_78$$));
        }
...
function $spf$nav$response$prepareAnimation_$$($data$$30$$) {
  ...
  var $element$$inline_80_refNode$$inline_85_refNode$$inline_88$$ = $data$$30$$.element, $container$$inline_81$$ = $data$$30$$.$oldEl$;
  if ($container$$inline_81$$) {
    for (var $child$$inline_82$$;$child$$inline_82$$ = $element$$inline_80_refNode$$inline_85_refNode$$inline_88$$.firstChild;) {
      $container$$inline_81$$.appendChild($child$$inline_82$$);
    }
    $element$$inline_80_refNode$$inline_85_refNode$$inline_88$$.appendChild($container$$inline_81$$);
  }
  $data$$30$$.$newEl$ = document.createElement("div");
  $data$$30$$.$newEl$.className = $data$$30$$.$newClass$;
  $data$$30$$.$newEl$.innerHTML = $data$$30$$.$html$;
  $data$$30$$.reverse ? ($element$$inline_80_refNode$$inline_85_refNode$$inline_88$$ = $data$$30$$.$oldEl$, $element$$inline_80_refNode$$inline_85_refNode$$inline_88$$.parentNode.insertBefore($data$$30$$.$newEl$, $element$$inline_80_refNode$$inline_85_refNode$$inline_88$$)) : ($element$$inline_80_refNode$$inline_85_refNode$$inline_88$$ = $data$$30$$.$oldEl$, $element$$inline_80_refNode$$inline_85_refNode$$inline_88$$.parentNode.insertBefore($data$$30$$.$newEl$, $element$$inline_80_refNode$$inline_85_refNode$$inline_88$$.nextSibling));
...
function $spf$nav$response$completeAnimation_$$($data$$32$$) {
  ...
  var $element$$inline_90$$ = $data$$32$$.$newEl$, $child$$inline_91$$, $parent$$inline_92$$ = $element$$inline_90$$.parentNode;
  if ($parent$$inline_92$$ && 11 != $parent$$inline_92$$.nodeType) {
    if ($element$$inline_90$$.removeNode) {
      $element$$inline_90$$.removeNode(!1);
    } else {
      for (;$child$$inline_91$$ = $element$$inline_90$$.firstChild;) {
        $parent$$inline_92$$.insertBefore($child$$inline_91$$, $element$$inline_90$$);
      }
      $parent$$inline_92$$.removeChild($element$$inline_90$$);
    }
  }
...
function $spf$nav$response$Animation_$$($el$$13$$, $html_node$$inline_99_prevName$$1$$, $cls$$6$$, $name$$79$$, $reverse$$) {
  var $duration_uid$$inline_103$$ = parseInt($spf$config$values$$["animation-duration"], 10);
  this.element = $el$$13$$;
  this.$html$ = $html_node$$inline_99_prevName$$1$$;
  this.duration = $duration_uid$$inline_103$$;
  this.reverse = $reverse$$;
  $html_node$$inline_99_prevName$$1$$ = document.body;
  $html_node$$inline_99_prevName$$1$$ = ($html_node$$inline_99_prevName$$1$$.dataset ? $html_node$$inline_99_prevName$$1$$.dataset.spfName : $html_node$$inline_99_prevName$$1$$.getAttribute("data-" + "spfName".replace(/([A-Z])/g, "-$1").toLowerCase())) || "";
  $duration_uid$$inline_103$$ = parseInt($spf$state$values_$$.uid, 10) || 0;
  $duration_uid$$inline_103$$++;
  this.key = $el$$13$$["spf-key"] || ($el$$13$$["spf-key"] = "" + $spf$state$set$$("uid", $duration_uid$$inline_103$$));
  this.$fromClass$ = $html_node$$inline_99_prevName$$1$$ && $cls$$6$$ + "-from-" + $html_node$$inline_99_prevName$$1$$;
...
function $spf$net$xhr$send$$($addContentTypeFormUrlEncoded_method$$2$$, $url$$61$$, $data$$34$$, $isFormData_opt_options$$17$$) {
  ...
  $xhr$$.onreadystatechange = function $$xhr$$$onreadystatechange$() {
    var $chunk$$1_firefoxSpdy$$inline_106_timing$$5$$ = $xhr$$.timing;
    if ($xhr$$.readyState == $spf$net$xhr$State$HEADERS_RECEIVED$$) {
      $chunk$$1_firefoxSpdy$$inline_106_timing$$5$$.responseStart = $chunk$$1_firefoxSpdy$$inline_106_timing$$5$$.responseStart || $spf$now$$();
      if ("json" == $xhr$$.responseType) {
        ...
        if (-1 < ($xhr$$.getResponseHeader("Transfer-Encoding") || "").toLowerCase().indexOf("chunked")) {
          ...
          var $chunk$$1_firefoxSpdy$$inline_106_timing$$5$$ = $xhr$$.getResponseHeader("X-Firefox-Spdy"), $chromeSpdy$$inline_108_loadTimes$$inline_107$$ = window.chrome && chrome.loadTimes && chrome.loadTimes(), $chromeSpdy$$inline_108_loadTimes$$inline_107$$ = $chromeSpdy$$inline_108_loadTimes$$inline_107$$ && $chromeSpdy$$inline_108_loadTimes$$inline_107$$.wasFetchedViaSpdy;
          $chunked$$ = !(!$chunk$$1_firefoxSpdy$$inline_106_timing$$5$$ && !$chromeSpdy$$inline_108_loadTimes$$inline_107$$);
        }
      }
      $options$$4$$.$onHeaders$ && $options$$4$$.$onHeaders$($xhr$$);
    } else {
      $xhr$$.readyState == $spf$net$xhr$State$LOADING$$ ? $chunked$$ && $options$$4$$.$onChunk$ && ($chunk$$1_firefoxSpdy$$inline_106_timing$$5$$ = $xhr$$.responseText.substring($offset$$14$$), $offset$$14$$ = $xhr$$.responseText.length, $options$$4$$.$onChunk$($xhr$$, $chunk$$1_firefoxSpdy$$inline_106_timing$$5$$)) : $xhr$$.readyState == $spf$net$xhr$State$DONE$$ && ($chunk$$1_firefoxSpdy$$inline_106_timing$$5$$.responseEnd = $chunk$$1_firefoxSpdy$$inline_106_timing$$5$$.responseEnd || $spf$now$$(), 
      window.performance && window.performance.getEntriesByName && ($xhr$$.resourceTiming = window.performance.getEntriesByName($url$$61$$).pop()), $chunked$$ && $options$$4$$.$onChunk$ && $xhr$$.responseText.length > $offset$$14$$ && ($chunk$$1_firefoxSpdy$$inline_106_timing$$5$$ = $xhr$$.responseText.substring($offset$$14$$), $offset$$14$$ = $xhr$$.responseText.length, $options$$4$$.$onChunk$($xhr$$, $chunk$$1_firefoxSpdy$$inline_106_timing$$5$$)), clearTimeout($timer$$), $options$$4$$.$onDone$ && 
...
function $spf$nav$request$send$$($url$$62$$, $opt_options$$18$$) {
  ...
  var $path$$inline_115_timing$$6_url$$inline_110$$ = $url$$62$$, $ident$$inline_112_requestUrl_uid$$inline_195$$ = $spf$config$values$$["url-identifier"] || "";
  if ($ident$$inline_112_requestUrl_uid$$inline_195$$) {
    var $ident$$inline_112_requestUrl_uid$$inline_195$$ = $ident$$inline_112_requestUrl_uid$$inline_195$$.replace("__type__", $fn$$inline_122_options$$5$$.type || ""), $hashParts$$inline_113_hashVal$$inline_119$$ = $spf$string$partition$$($path$$inline_115_timing$$6_url$$inline_110$$, "#"), $configHeaders_handleComplete_queryParts$$inline_114_queryVal$$inline_117$$ = $spf$string$partition$$($hashParts$$inline_113_hashVal$$inline_119$$[0], "?"), $path$$inline_115_timing$$6_url$$inline_110$$ = $configHeaders_handleComplete_queryParts$$inline_114_queryVal$$inline_117$$[0], 
    ...
    if (0 == $ident$$inline_112_requestUrl_uid$$inline_195$$.lastIndexOf("?", 0)) {
      $cacheKey_cached_headers_querySep$$inline_116$$ && ($ident$$inline_112_requestUrl_uid$$inline_195$$ = $ident$$inline_112_requestUrl_uid$$inline_195$$.replace("?", "&")), $configHeaders_handleComplete_queryParts$$inline_114_queryVal$$inline_117$$ += $ident$$inline_112_requestUrl_uid$$inline_195$$;
    } else {
      if (0 == $ident$$inline_112_requestUrl_uid$$inline_195$$.lastIndexOf(".", 0)) {
        if ($spf$string$endsWith$$($path$$inline_115_timing$$6_url$$inline_110$$, "/")) {
          $ident$$inline_112_requestUrl_uid$$inline_195$$ = "index" + $ident$$inline_112_requestUrl_uid$$inline_195$$;
        } else {
        ...
        $spf$string$endsWith$$($path$$inline_115_timing$$6_url$$inline_110$$, "/") && 0 == $ident$$inline_112_requestUrl_uid$$inline_195$$.lastIndexOf("/", 0) && ($ident$$inline_112_requestUrl_uid$$inline_195$$ = $ident$$inline_112_requestUrl_uid$$inline_195$$.substring(1));
      }
      $path$$inline_115_timing$$6_url$$inline_110$$ += $ident$$inline_112_requestUrl_uid$$inline_195$$;
    }
  ...
  $ident$$inline_112_requestUrl_uid$$inline_195$$ = $spf$url$absolute$$($path$$inline_115_timing$$6_url$$inline_110$$);
  $spf$debug$debug$$("    request url ", $ident$$inline_112_requestUrl_uid$$inline_195$$);
  $path$$inline_115_timing$$6_url$$inline_110$$ = {};
  $path$$inline_115_timing$$6_url$$inline_110$$.spfUrl = $ident$$inline_112_requestUrl_uid$$inline_195$$;
  ...
  if ($cacheKey_cached_headers_querySep$$inline_116$$) {
    var $fn$$inline_122_options$$5$$ = $spf$bind$$($spf$nav$request$handleResponseFromCache_$$, null, $url$$62$$, $fn$$inline_122_options$$5$$, $path$$inline_115_timing$$6_url$$inline_110$$, $cacheKey_cached_headers_querySep$$inline_116$$.key, $cacheKey_cached_headers_querySep$$inline_116$$.response), $chunking_headerId_key$$51_state$$inline_194_uid$$inline_123_xhrOpts$$;
    $chunking_headerId_key$$51_state$$inline_194_uid$$inline_123_xhrOpts$$ = window._spf_state = window._spf_state || {};
    $ident$$inline_112_requestUrl_uid$$inline_195$$ = parseInt($chunking_headerId_key$$51_state$$inline_194_uid$$inline_123_xhrOpts$$.uid, 10) || 0;
    $ident$$inline_112_requestUrl_uid$$inline_195$$++;
    $chunking_headerId_key$$51_state$$inline_194_uid$$inline_123_xhrOpts$$ = $chunking_headerId_key$$51_state$$inline_194_uid$$inline_123_xhrOpts$$.uid = $ident$$inline_112_requestUrl_uid$$inline_195$$;
    $spf$async$defers_$$[$chunking_headerId_key$$51_state$$inline_194_uid$$inline_123_xhrOpts$$] = $fn$$inline_122_options$$5$$;
    $spf$async$POSTMESSAGE_SUPPORTED_$$ ? window.postMessage($spf$async$PREFIX_$$ + $chunking_headerId_key$$51_state$$inline_194_uid$$inline_123_xhrOpts$$, "*") : window.setTimeout($spf$bind$$($spf$async$run_$$, null, $chunking_headerId_key$$51_state$$inline_194_uid$$inline_123_xhrOpts$$), 0);
    return null;
  }
  ...
  if ($configHeaders_handleComplete_queryParts$$inline_114_queryVal$$inline_117$$ = $spf$config$values$$["request-headers"]) {
    for ($chunking_headerId_key$$51_state$$inline_194_uid$$inline_123_xhrOpts$$ in $configHeaders_handleComplete_queryParts$$inline_114_queryVal$$inline_117$$) {
      $hashSep$$inline_118_value$$56$$ = $configHeaders_handleComplete_queryParts$$inline_114_queryVal$$inline_117$$[$chunking_headerId_key$$51_state$$inline_194_uid$$inline_123_xhrOpts$$], $cacheKey_cached_headers_querySep$$inline_116$$[$chunking_headerId_key$$51_state$$inline_194_uid$$inline_123_xhrOpts$$] = null == $hashSep$$inline_118_value$$56$$ ? "" : $hashSep$$inline_118_value$$56$$;
    }
  }
  if ($fn$$inline_122_options$$5$$.headers) {
    for ($chunking_headerId_key$$51_state$$inline_194_uid$$inline_123_xhrOpts$$ in $fn$$inline_122_options$$5$$.headers) {
      $hashSep$$inline_118_value$$56$$ = $fn$$inline_122_options$$5$$.headers[$chunking_headerId_key$$51_state$$inline_194_uid$$inline_123_xhrOpts$$], $cacheKey_cached_headers_querySep$$inline_116$$[$chunking_headerId_key$$51_state$$inline_194_uid$$inline_123_xhrOpts$$] = null == $hashSep$$inline_118_value$$56$$ ? "" : $hashSep$$inline_118_value$$56$$;
    }
  }
  ...
  if ($chunking_headerId_key$$51_state$$inline_194_uid$$inline_123_xhrOpts$$ = $spf$config$values$$["advanced-header-identifier"]) {
    $cacheKey_cached_headers_querySep$$inline_116$$["X-SPF-Request"] = $chunking_headerId_key$$51_state$$inline_194_uid$$inline_123_xhrOpts$$.replace("__type__", $fn$$inline_122_options$$5$$.type), $cacheKey_cached_headers_querySep$$inline_116$$.Accept = "application/json";
  }
  $chunking_headerId_key$$51_state$$inline_194_uid$$inline_123_xhrOpts$$ = new $spf$nav$request$Chunking_$$;
  $configHeaders_handleComplete_queryParts$$inline_114_queryVal$$inline_117$$ = $spf$bind$$($spf$nav$request$handleCompleteFromXHR_$$, null, $url$$62$$, $fn$$inline_122_options$$5$$, $path$$inline_115_timing$$6_url$$inline_110$$, $chunking_headerId_key$$51_state$$inline_194_uid$$inline_123_xhrOpts$$);
  $chunking_headerId_key$$51_state$$inline_194_uid$$inline_123_xhrOpts$$ = {headers:$cacheKey_cached_headers_querySep$$inline_116$$, $timeoutMs$:$spf$config$values$$["request-timeout"], $onHeaders$:$spf$bind$$($spf$nav$request$handleHeadersFromXHR_$$, null, $url$$62$$, $chunking_headerId_key$$51_state$$inline_194_uid$$inline_123_xhrOpts$$), $onChunk$:$spf$bind$$($spf$nav$request$handleChunkFromXHR_$$, null, $url$$62$$, $fn$$inline_122_options$$5$$, $path$$inline_115_timing$$6_url$$inline_110$$, $chunking_headerId_key$$51_state$$inline_194_uid$$inline_123_xhrOpts$$), 
  ...
  $fn$$inline_122_options$$5$$.withCredentials && ($chunking_headerId_key$$51_state$$inline_194_uid$$inline_123_xhrOpts$$.withCredentials = $fn$$inline_122_options$$5$$.withCredentials);
  $spf$config$values$$["advanced-response-type-json"] && ($chunking_headerId_key$$51_state$$inline_194_uid$$inline_123_xhrOpts$$.responseType = "json");
  return "POST" == $fn$$inline_122_options$$5$$.method ? $spf$net$xhr$send$$("POST", $ident$$inline_112_requestUrl_uid$$inline_195$$, $fn$$inline_122_options$$5$$.$postData$, $chunking_headerId_key$$51_state$$inline_194_uid$$inline_123_xhrOpts$$) : $spf$net$xhr$send$$("GET", $ident$$inline_112_requestUrl_uid$$inline_195$$, null, $chunking_headerId_key$$51_state$$inline_194_uid$$inline_123_xhrOpts$$);
}
...
function $spf$nav$request$done_$$($url$$67$$, $options$$9$$, $timing$$10$$, $response$$7$$, $cache_cacheKey$$2$$) {
  ...
  if ($cache_cacheKey$$2$$ && "POST" != $options$$9$$.method && ($cache_cacheKey$$2$$ = $spf$nav$request$getCacheKey_$$($url$$67$$, $options$$9$$.current, $response$$7$$.cacheType, $options$$9$$.type, !0))) {
    ...
    var $data$$inline_198_unit$$inline_219$$ = {response:$response$$7$$, type:$options$$9$$.type || ""}, $lifetime$$inline_199$$ = parseInt($spf$config$values$$["cache-lifetime"], 10), $JSCompiler_temp_const$$215_max$$inline_200$$ = parseInt($spf$config$values$$["cache-max"], 10);
    0 >= $lifetime$$inline_199$$ || 0 >= $JSCompiler_temp_const$$215_max$$inline_200$$ || ($JSCompiler_temp_const$$215_max$$inline_200$$ = $spf$cache$storage_$$(), $data$$inline_198_unit$$inline_219$$ = {data:$data$$inline_198_unit$$inline_219$$, life:$lifetime$$inline_199$$, time:$spf$now$$(), count:0}, $spf$cache$updateCount_$$($data$$inline_198_unit$$inline_219$$), $JSCompiler_temp_const$$215_max$$inline_200$$[$cache_cacheKey$$2$$] = $data$$inline_198_unit$$inline_219$$, setTimeout($spf$cache$collect$$, 
    1E3));
  }
...
function $spf$nav$request$getCacheObject_$$($cacheKey$$4$$, $opt_current$$1$$) {
  ...
  $spf$array$some$$($keys$$, function($key$$53$$) {
    ...
    a: {
      ...
      if ($key$$53$$ in $obj$$21_storage$$inline_130_unit$$inline_131$$) {
        $obj$$21_storage$$inline_130_unit$$inline_131$$ = $obj$$21_storage$$inline_130_unit$$inline_131$$[$key$$53$$];
    ...
    $obj$$21_storage$$inline_130_unit$$inline_131$$ && ($cacheValue$$ = {key:$key$$53$$, response:$obj$$21_storage$$inline_130_unit$$inline_131$$.response, type:$obj$$21_storage$$inline_130_unit$$inline_131$$.type});
...
function $spf$nav$navigateAddHistory_$$($url$$80$$, $referer$$, $handleError$$3$$) {
  try {
    ...
    $spf$url$absolute$$($url$$80$$, !0) != window.location.href && $spf$history$add$$($url$$80$$, {"spf-referer":$referer$$});
  } catch ($err$$4$$) {
...
function $spf$nav$reload$$($url$$84$$, $reason$$, $err$$9_opt_err$$) {
  ...
  setTimeout(function() {
    var $reloadId$$1_url$$inline_161$$ = $spf$config$values$$["reload-identifier"];
    if ($reloadId$$1_url$$inline_161$$) {
      var $params$$ = {};
      $params$$[$reloadId$$1_url$$inline_161$$] = encodeURIComponent($reason$$);
      var $reloadId$$1_url$$inline_161$$ = $url$$84$$, $result$$inline_163$$ = $spf$string$partition$$($reloadId$$1_url$$inline_161$$, "#"), $reloadId$$1_url$$inline_161$$ = $result$$inline_163$$[0], $delim$$inline_164$$ = -1 != $reloadId$$1_url$$inline_161$$.indexOf("?") ? "&" : "?", $key$$inline_165$$;
      for ($key$$inline_165$$ in $params$$) {
        $reloadId$$1_url$$inline_161$$ += $delim$$inline_164$$ + $key$$inline_165$$, $params$$[$key$$inline_165$$] && ($reloadId$$1_url$$inline_161$$ += "=" + $params$$[$key$$inline_165$$]), $delim$$inline_164$$ = "&";
      }
      $url$$84$$ = $reloadId$$1_url$$inline_161$$ + $result$$inline_163$$[1] + $result$$inline_163$$[2];
    }
...
function $spf$nav$prefetch_$$($absoluteUrl$$inline_169_url$$88$$, $options$$23_xhr$$inline_168$$, $info$$12$$) {
  $spf$debug$info$$("nav.prefetch ", $absoluteUrl$$inline_169_url$$88$$, $options$$23_xhr$$inline_168$$, $info$$12$$);
  $info$$12$$.$original$ = $info$$12$$.$original$ || $absoluteUrl$$inline_169_url$$88$$;
  if ($spf$nav$dispatchRequest_$$($absoluteUrl$$inline_169_url$$88$$, void 0, void 0, $options$$23_xhr$$inline_168$$, !0)) {
    var $handleError$$5$$ = $spf$bind$$($spf$nav$handleLoadError_$$, null, !0, $options$$23_xhr$$inline_168$$, $info$$12$$), $handlePart$$2$$ = $spf$bind$$($spf$nav$handleLoadPart_$$, null, !0, $options$$23_xhr$$inline_168$$, $info$$12$$), $handleSuccess$$2$$ = $spf$bind$$($spf$nav$handleLoadSuccess_$$, null, !0, $options$$23_xhr$$inline_168$$, $info$$12$$);
    $info$$12$$.type = "prefetch";
    $options$$23_xhr$$inline_168$$ = $spf$nav$request$send$$($absoluteUrl$$inline_169_url$$88$$, {method:$options$$23_xhr$$inline_168$$.method, headers:$options$$23_xhr$$inline_168$$.headers, $onPart$:$handlePart$$2$$, $onError$:$handleError$$5$$, $onSuccess$:$handleSuccess$$2$$, $postData$:$options$$23_xhr$$inline_168$$.postData, type:$info$$12$$.type, current:$info$$12$$.current});
    $spf$debug$debug$$("nav.addPrefetch ", $absoluteUrl$$inline_169_url$$88$$, $options$$23_xhr$$inline_168$$);
    $absoluteUrl$$inline_169_url$$88$$ = $spf$url$absolute$$($absoluteUrl$$inline_169_url$$88$$);
    $spf$nav$prefetches_$$()[$absoluteUrl$$inline_169_url$$88$$] = $options$$23_xhr$$inline_168$$;
  }
}
...
var $spf$nav$clearResourceTimings_$$, $clearResourceTimings$$inline_171$$ = window.performance && (window.performance.clearResourceTimings || window.performance.webkitClearResourceTimings || window.performance.mozClearResourceTimings || window.performance.msClearResourceTimings || window.performance.oClearResourceTimings);
$spf$nav$clearResourceTimings_$$ = $clearResourceTimings$$inline_171$$ ? $spf$bind$$($clearResourceTimings$$inline_171$$, window.performance) : $spf$nullFunction$$;
...
$spf$main$discover_$$();
var $spf$main$api_$$ = {init:function($config$$inline_176_opt_config$$1_url$$inline_210$$) {
  var $enable$$ = !("function" != typeof window.history.pushState && !$spf$history$getIframe$$().history.pushState);
  $spf$debug$info$$("main.init ", "enable=", $enable$$);
  $config$$inline_176_opt_config$$1_url$$inline_210$$ = $config$$inline_176_opt_config$$1_url$$inline_210$$ || {};
  for (var $errorCallback$$inline_209_key$$inline_177$$ in $spf$config$defaults$$) {
    $spf$config$values$$[$errorCallback$$inline_209_key$$inline_177$$] = $errorCallback$$inline_209_key$$inline_177$$ in $config$$inline_176_opt_config$$1_url$$inline_210$$ ? $config$$inline_176_opt_config$$1_url$$inline_210$$[$errorCallback$$inline_209_key$$inline_177$$] : $spf$config$defaults$$[$errorCallback$$inline_209_key$$inline_177$$];
  }
  for ($errorCallback$$inline_209_key$$inline_177$$ in $config$$inline_176_opt_config$$1_url$$inline_210$$) {
    $errorCallback$$inline_209_key$$inline_177$$ in $spf$config$defaults$$ || ($spf$config$values$$[$errorCallback$$inline_209_key$$inline_177$$] = $config$$inline_176_opt_config$$1_url$$inline_210$$[$errorCallback$$inline_209_key$$inline_177$$]);
  }
  if ($enable$$) {
    $errorCallback$$inline_209_key$$inline_177$$ = $spf$nav$dispatchError_$$;
    if (!$spf$state$values_$$["history-init"] && window.addEventListener) {
      $config$$inline_176_opt_config$$1_url$$inline_210$$ = window.location.href;
      ...
      $spf$state$set$$("history-error-callback", $errorCallback$$inline_209_key$$inline_177$$);
      $spf$state$set$$("history-listener", $spf$history$pop_$$);
      $spf$state$set$$("history-url", $config$$inline_176_opt_config$$1_url$$inline_210$$);
      $spf$state$set$$("history-timestamp", $spf$now$$());
      var $historyState$$inline_211$$ = {"spf-referer":document.referrer};
      try {
        $spf$history$replace$$($config$$inline_176_opt_config$$1_url$$inline_210$$, $historyState$$inline_211$$);
      } catch ($err$$inline_212$$) {
        $errorCallback$$inline_209_key$$inline_177$$ && $errorCallback$$inline_209_key$$inline_177$$($config$$inline_176_opt_config$$1_url$$inline_210$$, $err$$inline_212$$);
      }
    }
  ...
  for (var $key$$inline_181$$ in $spf$config$values$$) {
    delete $spf$config$values$$[$key$$inline_181$$];
  }
  ...
  $spf$cache$storage_$$({});
}}, history:{add:$spf$history$add$$, replace:$spf$history$replace$$}, script:{load:$spf$net$script$load$$, get:$spf$net$script$get$$, ready:$spf$net$script$ready$$, done:function($name$$67$$) {
