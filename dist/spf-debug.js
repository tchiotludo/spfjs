...
var $spf$config$defaults$$ = {"animation-class":"spf-animate", "animation-duration":425, "cache-lifetime":6E5, "cache-max":50, "cache-unified":!1, "link-class":"spf-link", "nolink-class":"spf-nolink", "navigate-limit":20, "navigate-lifetime":864E5, "reload-identifier":null, "request-timeout":0, "url-identifier":"?spf=__type__"};
function $spf$config$set$$($name$$50$$, $value$$54$$) {
  return $spf$config$values$$[$name$$50$$] = $value$$54$$;
}
...
function $spf$nav$request$send$$($url$$62$$, $opt_options$$18$$) {
  ...
  var $path$$inline_116_timing$$6_url$$inline_111$$ = $url$$62$$, $ident$$inline_113_requestUrl_uid$$inline_199$$ = $spf$config$values$$["url-identifier"] || "";
  if ($ident$$inline_113_requestUrl_uid$$inline_199$$) {
    var $ident$$inline_113_requestUrl_uid$$inline_199$$ = $ident$$inline_113_requestUrl_uid$$inline_199$$.replace("__type__", $fn$$inline_123_options$$5$$.type || ""), $hashParts$$inline_114_hashVal$$inline_120$$ = $spf$string$partition$$($path$$inline_116_timing$$6_url$$inline_111$$, "#"), $configHeaders_handleComplete_queryParts$$inline_115_queryVal$$inline_118$$ = $spf$string$partition$$($hashParts$$inline_114_hashVal$$inline_120$$[0], "?"), $path$$inline_116_timing$$6_url$$inline_111$$ = $configHeaders_handleComplete_queryParts$$inline_115_queryVal$$inline_118$$[0], 
    ...
    if (0 == $ident$$inline_113_requestUrl_uid$$inline_199$$.lastIndexOf("?", 0)) {
      $cacheKey_cached_headers_querySep$$inline_117$$ && ($ident$$inline_113_requestUrl_uid$$inline_199$$ = $ident$$inline_113_requestUrl_uid$$inline_199$$.replace("?", "&")), $configHeaders_handleComplete_queryParts$$inline_115_queryVal$$inline_118$$ += $ident$$inline_113_requestUrl_uid$$inline_199$$;
    } else {
      if (0 == $ident$$inline_113_requestUrl_uid$$inline_199$$.lastIndexOf(".", 0)) {
        if ($spf$string$endsWith$$($path$$inline_116_timing$$6_url$$inline_111$$, "/")) {
          $ident$$inline_113_requestUrl_uid$$inline_199$$ = "index" + $ident$$inline_113_requestUrl_uid$$inline_199$$;
        } else {
        ...
        $spf$string$endsWith$$($path$$inline_116_timing$$6_url$$inline_111$$, "/") && 0 == $ident$$inline_113_requestUrl_uid$$inline_199$$.lastIndexOf("/", 0) && ($ident$$inline_113_requestUrl_uid$$inline_199$$ = $ident$$inline_113_requestUrl_uid$$inline_199$$.substring(1));
      }
      $path$$inline_116_timing$$6_url$$inline_111$$ += $ident$$inline_113_requestUrl_uid$$inline_199$$;
    }
  ...
  $ident$$inline_113_requestUrl_uid$$inline_199$$ = $spf$url$absolute$$($path$$inline_116_timing$$6_url$$inline_111$$);
  $spf$debug$debug$$("    request url ", $ident$$inline_113_requestUrl_uid$$inline_199$$);
  $path$$inline_116_timing$$6_url$$inline_111$$ = {};
  $path$$inline_116_timing$$6_url$$inline_111$$.spfUrl = $ident$$inline_113_requestUrl_uid$$inline_199$$;
  ...
  if ($cacheKey_cached_headers_querySep$$inline_117$$) {
    var $fn$$inline_123_options$$5$$ = $spf$bind$$($spf$nav$request$handleResponseFromCache_$$, null, $url$$62$$, $fn$$inline_123_options$$5$$, $path$$inline_116_timing$$6_url$$inline_111$$, $cacheKey_cached_headers_querySep$$inline_117$$.key, $cacheKey_cached_headers_querySep$$inline_117$$.response), $chunking_headerId_key$$51_state$$inline_198_uid$$inline_124_xhrOpts$$;
    $chunking_headerId_key$$51_state$$inline_198_uid$$inline_124_xhrOpts$$ = window._spf_state = window._spf_state || {};
    $ident$$inline_113_requestUrl_uid$$inline_199$$ = parseInt($chunking_headerId_key$$51_state$$inline_198_uid$$inline_124_xhrOpts$$.uid, 10) || 0;
    $ident$$inline_113_requestUrl_uid$$inline_199$$++;
    $chunking_headerId_key$$51_state$$inline_198_uid$$inline_124_xhrOpts$$ = $chunking_headerId_key$$51_state$$inline_198_uid$$inline_124_xhrOpts$$.uid = $ident$$inline_113_requestUrl_uid$$inline_199$$;
    $spf$async$defers_$$[$chunking_headerId_key$$51_state$$inline_198_uid$$inline_124_xhrOpts$$] = $fn$$inline_123_options$$5$$;
    $spf$async$POSTMESSAGE_SUPPORTED_$$ ? window.postMessage($spf$async$PREFIX_$$ + $chunking_headerId_key$$51_state$$inline_198_uid$$inline_124_xhrOpts$$, "*") : window.setTimeout($spf$bind$$($spf$async$run_$$, null, $chunking_headerId_key$$51_state$$inline_198_uid$$inline_124_xhrOpts$$), 0);
    return null;
  }
  ...
  if ($configHeaders_handleComplete_queryParts$$inline_115_queryVal$$inline_118$$ = $spf$config$values$$["request-headers"]) {
    for ($chunking_headerId_key$$51_state$$inline_198_uid$$inline_124_xhrOpts$$ in $configHeaders_handleComplete_queryParts$$inline_115_queryVal$$inline_118$$) {
      $hashSep$$inline_119_value$$56$$ = $configHeaders_handleComplete_queryParts$$inline_115_queryVal$$inline_118$$[$chunking_headerId_key$$51_state$$inline_198_uid$$inline_124_xhrOpts$$], $cacheKey_cached_headers_querySep$$inline_117$$[$chunking_headerId_key$$51_state$$inline_198_uid$$inline_124_xhrOpts$$] = null == $hashSep$$inline_119_value$$56$$ ? "" : $hashSep$$inline_119_value$$56$$;
    }
  }
  if ($fn$$inline_123_options$$5$$.headers) {
    for ($chunking_headerId_key$$51_state$$inline_198_uid$$inline_124_xhrOpts$$ in $fn$$inline_123_options$$5$$.headers) {
      $hashSep$$inline_119_value$$56$$ = $fn$$inline_123_options$$5$$.headers[$chunking_headerId_key$$51_state$$inline_198_uid$$inline_124_xhrOpts$$], $cacheKey_cached_headers_querySep$$inline_117$$[$chunking_headerId_key$$51_state$$inline_198_uid$$inline_124_xhrOpts$$] = null == $hashSep$$inline_119_value$$56$$ ? "" : $hashSep$$inline_119_value$$56$$;
    }
  }
  ...
  if ($chunking_headerId_key$$51_state$$inline_198_uid$$inline_124_xhrOpts$$ = $spf$config$values$$["advanced-header-identifier"]) {
    $cacheKey_cached_headers_querySep$$inline_117$$["X-SPF-Request"] = $chunking_headerId_key$$51_state$$inline_198_uid$$inline_124_xhrOpts$$.replace("__type__", $fn$$inline_123_options$$5$$.type), $cacheKey_cached_headers_querySep$$inline_117$$.Accept = "application/json";
  }
  $chunking_headerId_key$$51_state$$inline_198_uid$$inline_124_xhrOpts$$ = new $spf$nav$request$Chunking_$$;
  $configHeaders_handleComplete_queryParts$$inline_115_queryVal$$inline_118$$ = $spf$bind$$($spf$nav$request$handleCompleteFromXHR_$$, null, $url$$62$$, $fn$$inline_123_options$$5$$, $path$$inline_116_timing$$6_url$$inline_111$$, $chunking_headerId_key$$51_state$$inline_198_uid$$inline_124_xhrOpts$$);
  $chunking_headerId_key$$51_state$$inline_198_uid$$inline_124_xhrOpts$$ = {headers:$cacheKey_cached_headers_querySep$$inline_117$$, $timeoutMs$:$spf$config$values$$["request-timeout"], $onHeaders$:$spf$bind$$($spf$nav$request$handleHeadersFromXHR_$$, null, $url$$62$$, $chunking_headerId_key$$51_state$$inline_198_uid$$inline_124_xhrOpts$$), $onChunk$:$spf$bind$$($spf$nav$request$handleChunkFromXHR_$$, null, $url$$62$$, $fn$$inline_123_options$$5$$, $path$$inline_116_timing$$6_url$$inline_111$$, $chunking_headerId_key$$51_state$$inline_198_uid$$inline_124_xhrOpts$$), 
  ...
  $fn$$inline_123_options$$5$$.withCredentials && ($chunking_headerId_key$$51_state$$inline_198_uid$$inline_124_xhrOpts$$.withCredentials = $fn$$inline_123_options$$5$$.withCredentials);
  $spf$config$values$$["advanced-response-type-json"] && ($chunking_headerId_key$$51_state$$inline_198_uid$$inline_124_xhrOpts$$.responseType = "json");
  return "POST" == $fn$$inline_123_options$$5$$.method ? $spf$net$xhr$send$$("POST", $ident$$inline_113_requestUrl_uid$$inline_199$$, $fn$$inline_123_options$$5$$.$postData$, $chunking_headerId_key$$51_state$$inline_198_uid$$inline_124_xhrOpts$$) : $spf$net$xhr$send$$("GET", $ident$$inline_113_requestUrl_uid$$inline_199$$, null, $chunking_headerId_key$$51_state$$inline_198_uid$$inline_124_xhrOpts$$);
}
...
function $spf$nav$request$done_$$($url$$67$$, $options$$9$$, $timing$$10$$, $response$$7$$, $cache_cacheKey$$2$$) {
  ...
  if ($cache_cacheKey$$2$$ && "POST" != $options$$9$$.method && ($cache_cacheKey$$2$$ = $spf$nav$request$getCacheKey_$$($url$$67$$, $options$$9$$.current, $response$$7$$.cacheType, $options$$9$$.type, !0))) {
    ...
    var $data$$inline_202_unit$$inline_217$$ = {response:$response$$7$$, type:$options$$9$$.type || ""}, $lifetime$$inline_203$$ = parseInt($spf$config$values$$["cache-lifetime"], 10), $JSCompiler_temp_const$$213_max$$inline_204$$ = parseInt($spf$config$values$$["cache-max"], 10);
    0 >= $lifetime$$inline_203$$ || 0 >= $JSCompiler_temp_const$$213_max$$inline_204$$ || ($JSCompiler_temp_const$$213_max$$inline_204$$ = $spf$cache$storage_$$(), $data$$inline_202_unit$$inline_217$$ = {data:$data$$inline_202_unit$$inline_217$$, life:$lifetime$$inline_203$$, time:$spf$now$$(), count:0}, $spf$cache$updateCount_$$($data$$inline_202_unit$$inline_217$$), $JSCompiler_temp_const$$213_max$$inline_204$$[$cache_cacheKey$$2$$] = $data$$inline_202_unit$$inline_217$$, setTimeout($spf$cache$collect$$, 
    1E3));
  }
...
$spf$main$discover_$$();
var $spf$main$api_$$ = {init:function($config$$inline_181_opt_config$$1_url$$inline_208$$) {
  ...
  $config$$inline_181_opt_config$$1_url$$inline_208$$ = $config$$inline_181_opt_config$$1_url$$inline_208$$ || {};
  for (var $errorCallback$$inline_207_key$$inline_182$$ in $spf$config$defaults$$) {
    $spf$config$set$$($errorCallback$$inline_207_key$$inline_182$$, $errorCallback$$inline_207_key$$inline_182$$ in $spf$config$values$$ ? $errorCallback$$inline_207_key$$inline_182$$ in $config$$inline_181_opt_config$$1_url$$inline_208$$ ? $config$$inline_181_opt_config$$1_url$$inline_208$$[$errorCallback$$inline_207_key$$inline_182$$] : $spf$config$values$$[$errorCallback$$inline_207_key$$inline_182$$] : $errorCallback$$inline_207_key$$inline_182$$ in $config$$inline_181_opt_config$$1_url$$inline_208$$ ? 
    $config$$inline_181_opt_config$$1_url$$inline_208$$[$errorCallback$$inline_207_key$$inline_182$$] : $spf$config$defaults$$[$errorCallback$$inline_207_key$$inline_182$$]);
  }
  for ($errorCallback$$inline_207_key$$inline_182$$ in $config$$inline_181_opt_config$$1_url$$inline_208$$) {
    $errorCallback$$inline_207_key$$inline_182$$ in $spf$config$defaults$$ || $spf$config$set$$($errorCallback$$inline_207_key$$inline_182$$, $config$$inline_181_opt_config$$1_url$$inline_208$$[$errorCallback$$inline_207_key$$inline_182$$]);
  }
  if ($enable$$) {
    $errorCallback$$inline_207_key$$inline_182$$ = $spf$nav$dispatchError_$$;
    if (!$spf$state$values_$$["history-init"] && window.addEventListener) {
      $config$$inline_181_opt_config$$1_url$$inline_208$$ = window.location.href;
      ...
      $spf$state$set$$("history-error-callback", $errorCallback$$inline_207_key$$inline_182$$);
      $spf$state$set$$("history-listener", $spf$history$pop_$$);
      $spf$state$set$$("history-url", $config$$inline_181_opt_config$$1_url$$inline_208$$);
      $spf$state$set$$("history-timestamp", $spf$now$$());
      var $historyState$$inline_209$$ = {"spf-referer":document.referrer};
      try {
        $spf$history$replace$$($config$$inline_181_opt_config$$1_url$$inline_208$$, $historyState$$inline_209$$);
      } catch ($err$$inline_210$$) {
        $errorCallback$$inline_207_key$$inline_182$$ && $errorCallback$$inline_207_key$$inline_182$$($config$$inline_181_opt_config$$1_url$$inline_208$$, $err$$inline_210$$);
      }
    }
  ...
  return $enable$$;
}, config:function($key$$56$$, $value$$58$$) {
  return $spf$config$set$$($key$$56$$, $value$$58$$);
}, dispose:function() {
